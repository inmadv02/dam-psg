...
public class MonumentoController {
    ...
    public ResponseEntity<List<GetMonumentoDto>> findAll() {
        ...
        /*return ResponseEntity Esta es otra forma de realizar este método
                .ok()
                .body(repository.findAll());*/

        List<Monumento> data = //Hemos hecho este cambio porque queremos mostrar una lista con la configuración de
                repository              //GetMonumentoDTO. Para ello, primero debemos mirar primero en la lista original
                        .findAll();     //de Monumento
